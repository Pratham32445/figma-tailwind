  ...
  return (
    <section className="relative min-h-screen">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        ...
        >
          <span className="block">Find Coal for Every</span>
        ...
        >
          Explore coal products tailored for your exact use — from
          high-performance industrial fuel to clean-burning domestic coal for
