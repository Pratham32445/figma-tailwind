      ...
      <div className="md:max-w-3xl lg:max-w-5xl xl:max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-sm sm:text-base leading-relaxed mb-6 max-w-prose mx-auto md:mx-0 font-poppins font-medium">
            {" "}
            We believe energy is more than a resource — it’s a right. Our
            mission is to make reliable fuel accessible to every industry, every
            home, and every region that needs it. <br />
            From powering a factory line to warming a winter night, coal still
            plays a vital role in supporting economies and daily lives. And
            we’re proud to be a responsible part of that chain.
          </p>
        </div>
      </div>
    </section>
